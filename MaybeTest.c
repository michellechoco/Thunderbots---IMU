...
#define X_Axis_Register_DATAX1 0x29 // Hexadecima address for the DATAX1 internal register.
...
int ADXAddress = 0b11010101; //213 or 0xD5 //Device address in which is also included the 8th bit for selecting the mode, read in this case.
//int ADXAddress = 0b11010111; //215 or 0xD7 
